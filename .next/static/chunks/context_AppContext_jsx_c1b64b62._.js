...
const AppContextProvider = ({ children })=>{
    ...
    const fetchUsersChats = async ()=>{
        try {
            const token = await getToken();
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/chat/get', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
//# sourceMappingURL=context_AppContext_jsx_c1b64b62._.js.map